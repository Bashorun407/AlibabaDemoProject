...
public class ClonedSheet {
    ...
    public void copyFromClonedSheetToSystem() throws IOException {
        ...
        String filePathCopiedTo = "C:\\Users\\Akinbobola Oluwaseyi\\Desktop\\data\\ClonedExcel.xlsx";
        FileOutputStream outputStream = new FileOutputStream(filePathCopiedTo);
        ...
        XSSFSheet sheet1 = workbook1.cloneSheet(1);
        XSSFSheet sheet2 = workbook2.createSheet("Sheet3");
